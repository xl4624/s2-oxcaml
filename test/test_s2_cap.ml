...
let () =
  ...
  Alcotest.run
    ...
    ; ( "quickcheck"
      , [ test_case "contains_center" `Quick quickcheck_contains_center
        ; test_case "complement_complement" `Quick quickcheck_complement_complement
        ; test_case "union_contains_both" `Quick quickcheck_union_contains_both
        ; test_case "add_point_contains" `Quick quickcheck_add_point_contains
        ; test_case "empty_subset_any" `Quick quickcheck_empty_subset_any
        ; test_case "any_subset_full" `Quick quickcheck_any_subset_full
        ] )
    ]
;;
