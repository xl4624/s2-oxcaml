...
let quickcheck_length_angle_roundtrip () =
...
let quickcheck_area_steradian_roundtrip () =
  Base_quickcheck.Test.run_exn
...
let quickcheck_points_vs_latlngs () =
  Base_quickcheck.Test.run_exn
...
let () =
  run
    ...
    ; ( "quickcheck"
      , [ test_case "length_angle_roundtrip" `Quick quickcheck_length_angle_roundtrip
        ; test_case "area_steradian_roundtrip" `Quick quickcheck_area_steradian_roundtrip
        ; test_case "points_vs_latlngs" `Quick quickcheck_points_vs_latlngs
        ] )
    ]
;;
