...
(** [vertex_neighbors t level] returns the cells at [level] that share the closest cell
    vertex to [t]. Returns 3 cells when the closest vertex is one of the 8 cube corners,
    otherwise 4 cells. [level] must be strictly less than [level t]. *)
